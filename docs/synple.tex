...
\caption{Opacity in the range 6100--6110. \AA\ for four combinations of a pair of densities ($\log_{10} \rho = -32.236191, -29.933606$) and temperatures ($\log_{10} = 8.059055, 8.51957$) and solar abundances.
\label{opacity-fig}
}
\end{figure}
